                    ...
                    <div class="sidebar-wrapper">
                        ...
                        <div class="single-sidebar mb-30">
                            ...
                            <div class="sidebar-post fix">
                                <!-- Image -->
                                <a href="blog-details.php" class="image"><img src="img/blog/sidebar-post-1.jpg" alt=""></a>
                                <!-- Content -->
                                <div class="content fix">
                                    <span class="date">14 JUN 2016</span>
                                    <a href="blog-details.php" class="title">Where can I get some?</a>
                            ...
                            <div class="sidebar-post fix">
                                <!-- Image -->
                                <a href="blog-details.php" class="image"><img src="img/blog/sidebar-post-2.jpg" alt=""></a>
                                <!-- Content -->
                                <div class="content fix">
                                    <span class="date">20 JUN 2016</span>
                                    <a href="blog-details.php" class="title">Going to use a passage.</a>
                                    <p>Many desktop publis packages and web page editors.</p>
                                </div>
                            </div>
                            ...
                            <div class="sidebar-post fix">
                                <!-- Image -->
                                <a href="blog-details.php" class="image"><img src="img/blog/sidebar-post-3.jpg" alt=""></a>
                                <!-- Content -->
                                <div class="content fix">
                                    <span class="date">20 JUN 2016</span>
                                    <a href="blog-details.php" class="title">Going to use a passage.</a>
